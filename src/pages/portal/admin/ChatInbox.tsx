...
import { Loader2, MessageCircle, Search, Lightbulb } from 'lucide-react';
...
import { FeatureRequestsKanban } from '@/components/admin/FeatureRequestsKanban';
import ClientAvatar from '@/components/portal/ClientAvatar';
import { Input } from '@/components/ui/input';
import { Badge } from '@/components/ui/badge';
import { cn } from '@/lib/utils';

type Tab = 'inbox' | 'feature_requests';
      ...
      <div className="h-full flex flex-col overflow-hidden">
        ...
        <div className="flex items-center border-b border-border/50 bg-card/50 px-4">
          ...
          >
            ...
            Inbox
            {totalUnread > 0 && (
              <Badge variant="destructive" className="rounded-full h-5 min-w-[20px] text-xs">
                {totalUnread}
              </Badge>
            )}
          </button>
