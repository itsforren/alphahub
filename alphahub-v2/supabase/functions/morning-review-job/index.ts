                ...
                elements: [
                  {
                    ...
                    url: `${Deno.env.get('PUBLIC_APP_URL') || 'https://alpha-agent-flow.lovable.app'}/hub/admin/command-center`,
                  },
                ],
              },
            ],
              ...
              },
              {
                ...
                elements: [
                  ...
                  },
                  {
                    ...
                    url:
                      `${Deno.env.get('PUBLIC_APP_URL') || 'https://alpha-agent-flow.lovable.app'}/hub/admin/command-center`,
                  },
                ],
              },
            ],
